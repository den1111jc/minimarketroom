...
import com.example.dz5room.databinding.TabPanelBinding
...
class TabPanel : Fragment(), View.OnClickListener, View.OnKeyListener {
    ...
    private var categoryRepository: CategoryRepository? = null // отсюда поставляются методы во вью модел
    private var categoryViewModel: CategoryViewModel? = null  //обработка бизнес логики
